package com.ekt.qa.common.gui.pages;

import com.ekt.qa.common.gui.webdriver.BaseSelenium;
import com.ekt.qa.common.gui.webdriver.WebdriverHelper;
...
/**
 * Abstract class for Page Objects. It contains some useful methods for the work with the web-pages on the EKT site
 *
 * @author Ilia_Efimov1
 * @version 21 Aug 2017
 */
public abstract class AbstractPageObject {
    ...
    protected void click(WebElement webElement, String webElemNameForLog) {
        ...
        log.info("Clicking on the " + webElemNameForLog);
    ...
    /**
     * Get the special element from the universal EKT dropdown menu
     *
     * @param elementToSelect  name of the element in the xPath
